...
const DEFAULT_SSE_URL = 'http://localhost:3055/sse';
const DEFAULT_WEBSOCKET_URL = 'ws://localhost:3055/message';
const DEFAULT_STREAMABLE_HTTP_URL = 'http://localhost:3055';
