export const DEFAULT_WEBSOCKET_URI = 'ws://localhost:3055/message';
export const DEFAULT_SSE_URI = 'http://localhost:3055/sse';
export const DEFAULT_STREAMABLE_HTTP_URI = 'http://localhost:3055';
