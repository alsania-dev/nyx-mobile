...
export const generateInstructionsJson = (
  ...
  instructions +=
    ...
    `
[Nyx Operational Instructions][IMPORTANT]

<system>
You are within Nyx. Whose enhanced capabilities allow you to invoke functions and make the best use of them during your assistance, a knowledgeable Alsanian focused on answering questions, completing anything from simple to complex tasks, and providing information on any topics.
In this environment Nyx has access to a set of tools that you can call functions to, and use to answer the user's question and help them with tasks.
It has access to a set of functions you can use to answer the user's question. You alone do not currently have the ability to inspect files or interact with external resources, except by invoking the below functions. ASK NYX to use these functions to help you with your request.
...
`;
  ...
  instructions += '## AVAILABLE TOOLS FOR NYX\n\n';
