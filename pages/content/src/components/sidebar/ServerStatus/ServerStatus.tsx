              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  placeholder={connectionType === 'sse' 
                    ? "http://localhost:3055/sse" 
                    : connectionType === 'websocket'
                      ? "ws://localhost:3055/message"
                      : "http://localhost:3055/mcp"}
                ...
                <div className="mt-2 text-xs text-slate-500 dark:text-slate-400">
                  <div className="mb-2">
                    <strong>To start Nyx MCP Proxy:</strong>
                  </div>
                  <div className="bg-slate-100 dark:bg-slate-800 p-2 rounded font-mono text-xs border">
                    npx @alsania-io/mcpnyx@latest --config ./config.json --outputTransport {connectionType === 'sse' ? 'sse' : connectionType === 'websocket' ? 'ws' : 'streamableHttp'}
                  </div>
